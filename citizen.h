...
private:
	...
	enum
	{
		...
		COND_CIT_HAS_HIGH_COVER, // [MODIFICATION-Dynamic Cover]
		COND_CIT_HAS_LOW_COVER, // [MODIFICATION-Dynamic Cover]
#ifdef EZ
		...
		TASK_CIT_MOVE_TO_HIGH_COVER,  // [MODIFICATION-Dynamic Cover]
		TASK_CIT_MOVE_TO_LOW_COVER,  // [MODIFICATION-Dynamic Cover]
#ifdef HL2_EPISODIC
		TASK_CIT_HEAL_TOSS,
#endif
#ifdef EZ
